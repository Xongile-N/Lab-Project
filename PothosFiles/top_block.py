...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_header_payload_demux_0 = digital.header_payload_demux(
        	  (hdr_format.header_nbits() * int(1.0/dec_hdr.rate())) /  qpsk.bits_per_symbol(),
        	  1,
        	  0,
        	  "payload symbols",
        	  "time_est",
        ...
        self.digital_costas_loop_cc_0_0_0 = digital.costas_loop_cc(6.28/200.0, qpsk.arity(), False)
        self.digital_costas_loop_cc_0_0 = digital.costas_loop_cc(6.28/200.0, qpsk.arity(), False)
        ...
        self.blocks_tagged_stream_multiply_length_0_0_0 = blocks.tagged_stream_multiply_length(gr.sizeof_char*1, "payload symbols", 0.125)
        self.blocks_tagged_stream_multiply_length_0_0 = blocks.tagged_stream_multiply_length(gr.sizeof_float*1, "payload symbols", qpsk.bits_per_symbol())
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1 , 'C:\\Users\\XongileN\\GoogleDrive\\2019\\Semester2\\ELEN40024012_lab_project\\Lab-Project\\TestSinks\\TestData.dat', True)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_1_0_0_0_1_0_2 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\XongileN\\GoogleDrive\\2019\\Semester2\\ELEN40024012_lab_project\\Lab-Project\\TestSinks\\QPSKRandSyncHeader.dat', False)
        self.blocks_file_sink_1_0_0_0_1_0_2.set_unbuffered(False)
        self.blocks_file_sink_1_0_0_0_1_0_0_2_0_0 = blocks.file_sink(gr.sizeof_float*1, 'C:\\Users\\XongileN\\GoogleDrive\\2019\\Semester2\\ELEN40024012_lab_project\\Lab-Project\\TestSinks\\QPSKRandSync3.dat', False)
        self.blocks_file_sink_1_0_0_0_1_0_0_2_0_0.set_unbuffered(False)
        self.blocks_file_sink_1_0_0_0_1_0_0_0_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\XongileN\\GoogleDrive\\2019\\Semester2\\ELEN40024012_lab_project\\Lab-Project\\TestSinks\\QPSKRandSync.dat', False)
        self.blocks_file_sink_1_0_0_0_1_0_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_1_0_0_0_1_0_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\XongileN\\GoogleDrive\\2019\\Semester2\\ELEN40024012_lab_project\\Lab-Project\\TestSinks\\QPSKRandSync1.dat', False)
        self.blocks_file_sink_1_0_0_0_1_0_0.set_unbuffered(False)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1_0_0, 0), (self.digital_corr_est_cc_0_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.blocks_file_sink_1_0_0_0_1_0_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.blocks_null_sink_0_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.blocks_tagged_stream_multiply_length_0_0_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_1, 0), (self.blocks_file_sink_1_0_0_0_1_0_2, 0))
        ...
        self.connect((self.blocks_tagged_stream_multiply_length_0_0, 0), (self.digital_binary_slicer_fb_0, 0))
        self.connect((self.blocks_tagged_stream_multiply_length_0_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_tagged_stream_multiply_length_0_0_0, 0), (self.digital_crc32_bb_1, 0))
        ...
        self.connect((self.digital_constellation_soft_decoder_cf_0_0, 0), (self.blocks_file_sink_1_0_0_0_1_0_0_2_0_0, 0))
        self.connect((self.digital_constellation_soft_decoder_cf_0_0, 0), (self.fec_generic_decoder_0, 0))
        self.connect((self.digital_corr_est_cc_0_0, 0), (self.blocks_multiply_by_tag_value_cc_0, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0_0_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.digital_crc32_bb_0, 0), (self.fec_tagged_encoder_1, 0))
        self.connect((self.digital_crc32_bb_1, 0), (self.blocks_file_sink_1_0_0_0_1_0_0_0_0, 0))
        ...
        self.connect((self.fec_generic_decoder_0, 0), (self.blocks_pack_k_bits_bb_1, 0))
