...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_insert_x_0_0 = blocks.vector_insert_b((232, ), hdr_format.header_nbits()/8+1, 0)
        self.blocks_vector_insert_x_0 = blocks.vector_insert_b((232, ), packetLength+1, 0)
        ...
        self.connect((self.blocks_vector_insert_x_0_0, 0), (self.blocks_stream_to_tagged_stream_0_0, 0))
        ...
        self.connect((self.digital_protocol_formatter_bb_0, 0), (self.blocks_vector_insert_x_0_0, 0))
    ...
    def set_packetLength(self, packetLength):
        ...
        self.blocks_stream_to_tagged_stream_0.set_packet_len(self.packetLength+1)
        self.blocks_stream_to_tagged_stream_0.set_packet_len_pmt(self.packetLength+1)
